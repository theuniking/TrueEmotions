        ...
        Column(
            ...
            CommonInputField(
                ...
                trailingIconRes = when {
                    (uiState.emailError == null && uiState.email.isNotEmpty()) -> R.drawable.ic_approve
            ...
            CommonInputField(
                ...
                errorText = uiState.nameError?.resolve() ?: String.empty,
                trailingIconColor = when {
                    uiState.nameError != null -> MaterialTheme.additionalColors.error
                    else -> MaterialTheme.additionalColors.correct
                },
                trailingIconRes = when {
                    (uiState.nameError == null && uiState.name.isNotEmpty()) -> R.drawable.ic_approve
                    uiState.nameError != null -> R.drawable.ic_disapprove
                    else -> null
                },
            )
            Spacer(modifier = Modifier.height(8.dp))
            CommonInputField(
                ...
                errorText = uiState.passwordError?.resolve() ?: String.empty,
                trailingIconColor = when {
                    uiState.passwordError != null -> MaterialTheme.additionalColors.error
                    else -> MaterialTheme.additionalColors.primaryIcon
                },
